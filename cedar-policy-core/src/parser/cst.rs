...
/// SlotTypeAnnotations: a vector of pairs consisting of a slot and it's type
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct SlotTypeAnnotations {
...
pub struct PolicyImpl {
    ...
    /// Slot type annotations
    pub slot_type_annotations: Option<Node<SlotTypeAnnotations>>,
    /// policy effect
